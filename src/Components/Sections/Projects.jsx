...
const Projects = ({ resumeData, isDark }) => {
  ...
  return (
    <section id="projects" className={`relative px-6 md:px-10 pt-32 pb-10 max-w-7xl mx-auto overflow-hidden ${isDark ? 'bg-black text-zinc-400' : 'bg-white text-zinc-600'}`}>
