          ...
          >
            <div className="flex flex-col gap-8 items-start">
              ...
              <motion.div variants={itemVariants} className="flex gap-4 mt-4">
                <button onClick={openTerminal} className={`p-4 rounded-xl border ${isDark ? 'border-zinc-800 bg-zinc-900/50 text-green-400' : 'border-zinc-200 bg-zinc-50 text-blue-600'}`}>
                  <Terminal size={20} />
                </button>
